...
#     output_dir='saved_model/test_trainer_demo2',          # output directory
...
Train_X, Test_X, Train_Y, Test_Y = model_selection.train_test_split(Corpus['forum_message'], labelCol, test_size=0.2, random_state=111)
