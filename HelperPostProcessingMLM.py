...
Corpus = pd.read_csv('data/pretrain/forum_2021_lang_lal_20_mlm.csv', encoding='latin-1')
...
Corpus.to_csv('data/pretrain/forum_2021_lang_lal_20_mlm.csv',index=False)
