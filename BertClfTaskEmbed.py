...
Corpus = pd.read_csv('data/Monash_fine_tune_clean_embed.csv', encoding='latin-1')
...
Train_X, Test_X, Train_Y, Test_Y = model_selection.train_test_split(Corpus, labelCol, test_size=0.2, random_state=2)
